...
In biological systems, this framework has become especially important because such demixing can give rise to biomolecular condensates that compartmentalise cellular matter without a surrounding membrane, thereby creating distinct biochemical environments \cite{Kilgore2023}.
Such condensates are implicated in diverse biological contexts, including development \cite{So2021}, gene regulation \cite{Pei2025}, protein quality control \cite{Rajendran2025}, and signalling \cite{Jaqaman2021}, are linked to pathological states such as neurodegeneration \cite{Mathieu2020} and cancer \cite{Cai2021BiomolecularCA}, and are found from the nucleus \cite{Lafontaine2020} and cytosol \cite{Banani2017} to membranes \cite{Jaqaman2021}.
A theoretical description of these systems must therefore bridge multiple length scales: microscopic molecular interactions \cite{Dignon2020}, which induce phase separation and macroscopic surface effects such as Marangoli flows \cite{Michelin2023} and wetting \cite{Cahn1977} that govern condensate behaviour at the cellular scale.

Compared with binary mixtures, ternary systems already display a much richer phenomenology. Their phase diagrams are two-dimensional, tie-lines can vary across composition space, three-phase coexistence can occur \cite{Scott1949}, and interfaces may exhibit preferential adsorption of one component \cite{Huang1996AnalyticInterface}. These features make ternary mixtures a natural minimal setting in which to study genuinely multicomponent effects. They are also of practical interest, since many biological and synthetic mixtures contain multiple species whose interactions cannot be reduced to an effectively binary description \cite{VEATCH20033074,Kaur2021}. Ternary phase separation has therefore attracted considerable theoretical attention, for example in the context of chemically regulated condensates \cite{Kirschbaum2021Controlling} and self-propulsion in droplets \cite{Demarchi2023EnzymeEnriched}.

Two complementary questions are central to the study of ternary phase separation. First, which bulk states can the system realize? This is the role of the phase diagram: it identifies coexistence regions, critical points, tie-lines, and possible three-phase equilibria, and thereby provides the global map needed to predict how a mixture responds to changes in composition or interaction strength. Several methods have been developed to reconstruct binodals directly from interaction matrices, including analytic approaches, genetic algorithms, and constructions based on convexification of the free-energy landscape \cite{Milani2007,WEI200691,Mao2019}.

Second, how are coexisting phases connected in space? This is the role of interfacial physics. The structure and free-energy cost of an interface influence nucleation barriers, relaxation dynamics, and the stability of phase-separated states \cite{Philippe2015,zwicker2025physicsdropletregulationbiological}. Composition-dependent surface tension can drive Marangoni flows along interfaces, leading to spreading and contraction dynamics in ternary droplets \cite{Baumgartner2022}. In ternary mixtures, interfaces are particularly interesting because one component can adsorb preferentially at the interface and thereby alter the surface tension and the profile shape. Classic studies of symmetric ternary mixtures showed that these interfacial properties can differ qualitatively from their binary counterparts \cite{Huang1996,Huang1996AnalyticInterface,Huang1999}.

These two perspectives, global phase behavior and local interfacial structure, are naturally linked. Phase diagrams identify the relevant coexisting bulk phases, while interfacial calculations characterize the boundaries between them. This thesis focuses on these two complementary aspects within ternary Flory-Huggins theory. First, we investigate the structure and energetics of diffuse interfaces, with particular emphasis on the role of interfacial adsorption and on analytical approximations for the surface tension. Second, we develop a continuation-based numerical method for the rapid construction of ternary binodals and phase diagrams directly from the coexistence conditions. Together, these results connect local interfacial physics with the global organization of phase space.

...
On this symmetry line, exchanging species \(0\) and \(1\) leaves the free energy invariant, so the corresponding equilibrium profiles have the same fitted interfacial width.
Interfacial adsorption is therefore captured by the relative shift of their centers, and the difference between the fitted interface positions \(x_0\) for the two species provides a direct measure of the degree of adsorption.\\

...
In this way, we collect surface-tension values along the binodal for different values of the chemical potential \(\mu_2(\bar\phi_2)\) of species 2.
...
vanishes across the interface. Here, the terms $V$ and $T$ play roles analogous
...
diverging interfacial width observed in the numerical results, while the critical exponent of the surface tension, \(\gamma \sim |\boldsymbol{\mu}_c-\boldsymbol{\mu}|^{3/2}\), is consistent

...
\]
Along the binodals considered here, \(\mu_2\) provides a convenient scalar parametrization of the distance from criticality. In the asymptotic analysis below, we show that this scaling can be expressed more generally in terms of the full chemical-potential distance \(|\boldsymbol{\mu}-\boldsymbol{\mu}_c|\).
...
Before introducing the approximation, we will introduce a conserved quantity of the equilibrium interfacial problem, which we will use in our approximation. 
